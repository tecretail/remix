  ...
  if (!window.__pgCodRowWatch) {
    ...
    if (!document.getElementById('pg-cod-anim-kill')) {
      ...
      st.textContent = [
        ...
        '0%,100%{box-shadow:0 0 0 3px rgba(57,232,90,.25),0 0 12px rgba(57,255,120,.35),0 4px 14px rgba(5,68,151,.1);border-color:#39e85a}',
        '50%{box-shadow:0 0 0 5px rgba(57,232,90,.45),0 0 22px rgba(57,255,120,.7),0 6px 18px rgba(47,158,68,.25);border-color:#5dff7a}',
        '}',
        '.pg-cod-bounce-wrap{',
